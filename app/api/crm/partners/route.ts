...
export async function POST(request: Request) {
  ...
  await Promise.allSettled([
    supabase.from('audit_logs').insert({
      ...
      new_data: { name: form.name, submission_email: form.submission_email || null, product_types: csv(form.product_types), invite_email: inviteEmail || null, email_sent: emailSent },
    }),
