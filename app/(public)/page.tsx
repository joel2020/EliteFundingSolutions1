...
const faqs = [
  ...
  ['What credit score do I need?', 'All credits accepted. Funding options depend on revenue, deposits, business history, and funder underwriting requirements rather than a minimum credit score.'],
