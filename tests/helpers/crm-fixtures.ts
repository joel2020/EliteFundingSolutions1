...
export function createCrmState(role: MockRole = 'admin'): MockState {
  ...
  return {
    ...
    partner_submissions: [
      { id: 'submission-1', organization_id: ORG_ID, deal_id: DEAL_ID, funding_partner_id: '88888888-8888-8888-8888-888888888888', submitted_by: ADMIN_PROFILE_ID, submitted_at: now, status: 'in_review', notes: 'Submitted via portal.', custom_message: 'Please review this file for a working capital offer.', created_at: now, updated_at: now },
      { id: 'submission-prior-1', organization_id: ORG_ID, deal_id: 'deal-prior-1', funding_partner_id: '88888888-8888-8888-8888-888888888888', submitted_by: ADMIN_PROFILE_ID, submitted_at: '2026-01-03T12:00:00.000Z', status: 'funded', notes: 'Prior funded submission.', custom_message: 'Prior lender-facing note.', created_at: '2026-01-03T12:00:00.000Z', updated_at: '2026-01-10T12:00:00.000Z' },
    ],
...
export async function mockCrmApis(page: Page, role: MockRole = 'admin') {
  ...
  await page.route('**/api/crm/deals/*/lender-submissions', async (route) => {
    ...
    const submission = {
      ...
      submitted_at: now,
      status: 'submitted',
      notes: payload.internal_note || null,
